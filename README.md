...
**Live `h1spec --strict` scorecard** — 32/32 of the checks that get an answer pass.

🟢 **32 pass**  ·  ⚪ 1 blocked by [#103](https://github.com/enghitalo/vanilla/issues/103)
...
_h1spec `--strict`, live socket · commit `a00a855` · [run log](https://github.com/enghitalo/vanilla/actions/runs/29352371266) · regenerated by CI on every merge_
