...
**Live `h1spec --strict` scorecard** — 20/22 of the checks that get an answer pass.

🟢 **20 pass**  ·  🔴 **2 fail**  ·  ⚪ 11 blocked by [#103](https://github.com/enghitalo/vanilla/issues/103)

> [!CAUTION]
> **2 real conformance gaps** below (🔴) — a *wrong* answer, not a dropped one. ⚪ rows are the half-close bug ([#103](https://github.com/enghitalo/vanilla/issues/103)), not handler failures.
...
| ⚪ | OPTIONS * request-target accepted | blocked · #103 |
| ⚪ | Absolute-form request-target accepted | blocked · #103 |
| ⚪ | CONNECT authority-form accepted | blocked · #103 |
...
| 🔴 | Chunked + HTTP/1.0 rejected <sub>Expected 400, got 200</sub> | **FAIL** |
...
| 🔴 | Missing chunk terminator rejected <sub>Expected a 400 or immediate close, got status sequence [200, 200]</sub> | **FAIL** |
| ⚪ | Expect: 100-continue handling | blocked · #103 |
...
_h1spec `--strict`, live socket · commit `c21480a` · [run log](https://github.com/enghitalo/vanilla/actions/runs/29343754272) · regenerated by CI on every merge_
