...
**Live `h1spec --strict` scorecard** — 31/32 of the checks that get an answer pass.

🟢 **31 pass**  ·  🔴 **1 fail**  ·  ⚪ 1 blocked by [#103](https://github.com/enghitalo/vanilla/issues/103)

> [!CAUTION]
> **1 real conformance gap** below (🔴) — a *wrong* answer, not a dropped one. ⚪ rows are the half-close bug ([#103](https://github.com/enghitalo/vanilla/issues/103)), not handler failures.
...
_h1spec `--strict`, live socket · commit `98a70b7` · [run log](https://github.com/enghitalo/vanilla/actions/runs/29349723536) · regenerated by CI on every merge_
